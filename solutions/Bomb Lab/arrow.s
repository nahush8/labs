...
,--80486f7:	74 05                	je     80486fe <_init+0x1e>; jump if equal
...
,-----804891d:	75 3e                	jne    804895d <__do_global_dtors_aux+0x4d>; jump if not equal
| ,---804891f:	eb 12                	jmp    8048933 <__do_global_dtors_aux+0x23>; jump unconditional
...
|  '--804893b:	75 e4                	jne    8048921 <__do_global_dtors_aux+0x11>; jump if not equal
|     804893d:	b8 c0 87 04 08       	mov    $0x80487c0,%eax
|     8048942:	85 c0                	test   %eax,%eax
|,----8048944:	74 0d                	je     8048953 <__do_global_dtors_aux+0x43>; jump if equal
...
,--804897d:	74 12                	je     8048991 <frame_dummy+0x21>; jump if equal
...
080489b0 <main>:
   ...
   ,--80489c0:	75 0e                	jne    80489d0 <main+0x20>; jump if not equal
   |  80489c2:	a1 48 b6 04 08       	mov    0x804b648,%eax
   |  80489c7:	a3 64 b6 04 08       	mov    %eax,0x804b664
,--|--80489cc:	eb 62                	jmp    8048a30 <main+0x80>; jump unconditional
|  |  80489ce:	89 f6                	mov    %esi,%esi
|  '->80489d0:	83 f8 02             	cmp    $0x2,%eax
| ,---80489d3:	75 3b                	jne    8048a10 <main+0x60>; jump if not equal
...
|,|---80489f0:	75 3e                	jne    8048a30 <main+0x80>; jump if not equal
...
,--8048b3c:	74 05                	je     8048b43 <phase_1+0x23>; jump if equal
...
08048b48 <phase_2>:
  ...
  ,--8048b67:	74 05                	je     8048b6e <phase_2+0x26>; jump if equal
...
,|---8048b81:	74 05                	je     8048b88 <phase_2+0x40>; jump if equal
||   8048b83:	e8 74 09 00 00       	call   80494fc <explode_bomb>
'|-->8048b88:	43                   	inc    %ebx
 |   8048b89:	83 fb 05             	cmp    $0x5,%ebx
 '---8048b8c:	7e e8                	jle    8048b76 <phase_2+0x2e>; jump if less or equal
...
08048b98 <phase_3>:
                  ...
                  ,--8048bc2:	7f 05                	jg     8048bc9 <phase_3+0x31>; jump if greater
                  |  8048bc4:	e8 33 09 00 00       	call   80494fc <explode_bomb>
                  '->8048bc9:	83 7d f4 07          	cmpl   $0x7,-0xc(%ebp)
                 ,---8048bcd:	0f 87 b5 00 00 00    	ja     8048c88 <phase_3+0xf0>; jump if above
      ...
      ,----------|---8048be9:	0f 84 a0 00 00 00    	je     8048c8f <phase_3+0xf7>; jump if equal
      |          |   8048bef:	e8 08 09 00 00       	call   80494fc <explode_bomb>
      |         ,|---8048bf4:	e9 96 00 00 00       	jmp    8048c8f <phase_3+0xf7>; jump unconditional
...
08048ca0 <func4>:
 ...
 ,--8048cae:	7e 20                	jle    8048cd0 <func4+0x30>; jump if less or equal
...
,|--8048ccc:	eb 07                	jmp    8048cd5 <func4+0x35>; jump unconditional
...
08048ce0 <phase_4>:
  ...
  ,--8048d01:	75 06                	jne    8048d09 <phase_4+0x29>; jump if not equal
  |  8048d03:	83 7d fc 00          	cmpl   $0x0,-0x4(%ebp)
 ,|--8048d07:	7f 05                	jg     8048d0e <phase_4+0x2e>; jump if greater
...
,----8048d20:	74 05                	je     8048d27 <phase_4+0x47>; jump if equal
...
08048d2c <phase_5>:
  ...
  ,--8048d46:	74 05                	je     8048d4d <phase_5+0x21>; jump if equal
 ...
 '---8048d69:	7e ec                	jle    8048d57 <phase_5+0x2b>; jump if less or equal
...
,----8048d85:	74 05                	je     8048d8c <phase_5+0x60>; jump if equal
...
08048d98 <phase_6>:
         ...
         ,|--8048dca:	76 05                	jbe    8048dd1 <phase_6+0x39>; jump if below or equal
         ||  8048dcc:	e8 2b 07 00 00       	call   80494fc <explode_bomb>
         '|->8048dd1:	8d 5f 01             	lea    0x1(%edi),%ebx
          |  8048dd4:	83 fb 05             	cmp    $0x5,%ebx
      ,---|--8048dd7:	7f 23                	jg     8048dfc <phase_6+0x64>; jump if greater
      ...
      |,|-|--8048def:	75 05                	jne    8048df6 <phase_6+0x5e>; jump if not equal
      ||| |  8048df1:	e8 06 07 00 00       	call   80494fc <explode_bomb>
      |'|-|->8048df6:	43                   	inc    %ebx
      | | |  8048df7:	83 fb 05             	cmp    $0x5,%ebx
      | '-|--8048dfa:	7e ea                	jle    8048de6 <phase_6+0x4e>; jump if less or equal
      '---|->8048dfc:	47                   	inc    %edi
          |  8048dfd:	83 ff 05             	cmp    $0x5,%edi
          '--8048e00:	7e be                	jle    8048dc0 <phase_6+0x28>; jump if less or equal
   ...
   ,-|-------8048e24:	7d 12                	jge    8048e38 <phase_6+0xa0>; jump if greater or equal
   ...
   |'|-------8048e36:	7c f8                	jl     8048e30 <phase_6+0x98>; jump if less
   '-|------>8048e38:	8b 55 c4             	mov    -0x3c(%ebp),%edx
     |       8048e3b:	89 34 ba             	mov    %esi,(%edx,%edi,4)
     |       8048e3e:	47                   	inc    %edi
     |       8048e3f:	83 ff 05             	cmp    $0x5,%edi
     '-------8048e42:	7e cc                	jle    8048e10 <phase_6+0x78>; jump if less or equal
  ...
  '----------8048e5e:	7e f2                	jle    8048e52 <phase_6+0xba>; jump if less or equal
...
,|-----------8048e77:	7d 05                	jge    8048e7e <phase_6+0xe6>; jump if greater or equal
||           8048e79:	e8 7e 06 00 00       	call   80494fc <explode_bomb>
'|---------->8048e7e:	8b 76 08             	mov    0x8(%esi),%esi
 |           8048e81:	47                   	inc    %edi
 |           8048e82:	83 ff 04             	cmp    $0x4,%edi
 '-----------8048e85:	7e e9                	jle    8048e70 <phase_6+0xd8>; jump if less or equal
...
08048e94 <fun7>:
     ...
     ,--8048ea2:	75 0c                	jne    8048eb0 <fun7+0x1c>; jump if not equal
     |  8048ea4:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  ,--|--8048ea9:	eb 37                	jmp    8048ee2 <fun7+0x4e>; jump unconditional
  |  |  8048eab:	90                   	nop
  |  |  8048eac:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  |  '->8048eb0:	3b 02                	cmp    (%edx),%eax
  | ,---8048eb2:	7d 11                	jge    8048ec5 <fun7+0x31>; jump if greater or equal
 ...
 ,|-|---8048ec3:	eb 1d                	jmp    8048ee2 <fun7+0x4e>; jump unconditional
 || '-->8048ec5:	3b 02                	cmp    (%edx),%eax
 ||,----8048ec7:	74 17                	je     8048ee0 <fun7+0x4c>; jump if equal
 ...
 |||    8048ed8:	40                   	inc    %eax
,|||----8048ed9:	eb 07                	jmp    8048ee2 <fun7+0x4e>; jump unconditional
||||    8048edb:	90                   	nop
...
08048ee8 <secret_phase>:
 ...
 ,--8048f0d:	76 05                	jbe    8048f14 <secret_phase+0x2c>; jump if below or equal
...
,---8048f28:	74 05                	je     8048f2f <secret_phase+0x47>; jump if equal
...
,--804900a:	7f 05                	jg     8049011 <read_six_numbers+0x39>; jump if greater
...
,---8049023:	74 07                	je     804902c <string_length+0x14>; jump if equal
|,->8049025:	42                   	inc    %edx
||  8049026:	40                   	inc    %eax
||  8049027:	80 3a 00             	cmpb   $0x0,(%edx)
|'--804902a:	75 f9                	jne    8049025 <string_length+0xd>; jump if not equal
...
08049030 <strings_not_equal>:
   ...
   ,---8049055:	74 09                	je     8049060 <strings_not_equal+0x30>; jump if equal
   |,->8049057:	b8 01 00 00 00       	mov    $0x1,%eax
,--||--804905c:	eb 21                	jmp    804907f <strings_not_equal+0x4f>; jump unconditional
|  ||  804905e:	89 f6                	mov    %esi,%esi
|  '|->8049060:	89 f2                	mov    %esi,%edx
|   |  8049062:	89 f9                	mov    %edi,%ecx
|   |  8049064:	80 3a 00             	cmpb   $0x0,(%edx)
|,--|--8049067:	74 14                	je     804907d <strings_not_equal+0x4d>; jump if equal
||  |  8049069:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
||,-|->8049070:	8a 02                	mov    (%edx),%al
||| |  8049072:	3a 01                	cmp    (%ecx),%al
||| '--8049074:	75 e1                	jne    8049057 <strings_not_equal+0x27>; jump if not equal
|||    8049076:	42                   	inc    %edx
|||    8049077:	41                   	inc    %ecx
|||    8049078:	80 3a 00             	cmpb   $0x0,(%edx)
||'----804907b:	75 f3                	jne    8049070 <strings_not_equal+0x40>; jump if not equal
...
0804908c <open_clientfd>:
  ...
  ,--80490a9:	7d 17                	jge    80490c2 <open_clientfd+0x36>; jump if greater or equal
 ...
 ,---80490d5:	75 19                	jne    80490f0 <open_clientfd+0x64>; jump if not equal
...
,----804913c:	7d 17                	jge    8049155 <open_clientfd+0xc9>; jump if greater or equal
...
0804917c <blank_line>:
 ...
 ,----8049185:	74 1e                	je     80491a5 <blank_line+0x29>; jump if equal
 ...
 |,|--8049199:	75 05                	jne    80491a0 <blank_line+0x24>; jump if not equal
 |||  804919b:	31 c0                	xor    %eax,%eax
,|||--804919d:	eb 0b                	jmp    80491aa <blank_line+0x2e>; jump unconditional
||||  804919f:	90                   	nop
||'|->80491a0:	80 3a 00             	cmpb   $0x0,(%edx)
|| '--80491a3:	75 eb                	jne    8049190 <blank_line+0x14>; jump if not equal
...
,|--80491df:	74 10                	je     80491f1 <skip+0x41>; jump if equal
...
|'--80491ef:	75 c6                	jne    80491b7 <skip+0x7>; jump if not equal
...
080491fc <read_line>:
  ...
  ,----804920a:	75 53                	jne    804925f <read_line+0x63>; jump if not equal
  |    804920c:	a1 64 b6 04 08       	mov    0x804b664,%eax
  |    8049211:	3b 05 48 b6 04 08    	cmp    0x804b648,%eax
  |,---8049217:	74 31                	je     804924a <read_line+0x4e>; jump if equal
  ...
  ||,--804922b:	74 0a                	je     8049237 <read_line+0x3b>; jump if equal
 ...
 ,||---8049248:	75 15                	jne    804925f <read_line+0x63>; jump if not equal
...
,------8049284:	75 12                	jne    8049298 <read_line+0x9c>; jump if not equal
...
080492c0 <send_msg>:
           ...
           ,--80492db:	75 17                	jne    80492f4 <send_msg+0x34>; jump if not equal
          ...
          ,---8049304:	75 1a                	jne    8049320 <send_msg+0x60>; jump if not equal
         ...
         ,----8049329:	75 17                	jne    8049342 <send_msg+0x82>; jump if not equal
        ...
        ,-----8049370:	75 1e                	jne    8049390 <send_msg+0xd0>; jump if not equal
       ...
       ,|-----8049387:	eb 17                	jmp    80493a0 <send_msg+0xe0>; jump unconditional
      ...
      ,-------80493b2:	74 05                	je     80493b9 <send_msg+0xf9>; jump if equal
    ...
    ,---------80493df:	7d 3a                	jge    804941b <send_msg+0x15b>; jump if greater or equal
    ...
    |'--------8049419:	7c c6                	jl     80493e1 <send_msg+0x121>; jump if less
   ...
   ,----------804945a:	74 17                	je     8049473 <send_msg+0x1b3>; jump if equal
  ...
  ,-----------8049481:	74 1d                	je     80494a0 <send_msg+0x1e0>; jump if equal
 ...
 ,------------80494ae:	74 17                	je     80494c7 <send_msg+0x207>; jump if equal
...
,-------------80494d5:	74 19                	je     80494f0 <send_msg+0x230>; jump if equal
...
,----804953a:	75 63                	jne    804959f <phase_defused+0x73>; jump if not equal
...
| ,--8049559:	75 37                	jne    8049592 <phase_defused+0x66>; jump if not equal
...
|,|--804956e:	75 22                	jne    8049592 <phase_defused+0x66>; jump if not equal
...
,---80495c3:	74 0c                	je     80495d1 <__do_global_ctors_aux+0x21>; jump if equal
|,->80495c5:	8b 03                	mov    (%ebx),%eax
||  80495c7:	ff d0                	call   *%eax
||  80495c9:	83 c3 fc             	add    $0xfffffffc,%ebx
||  80495cc:	83 3b ff             	cmpl   $0xffffffff,(%ebx)
|'--80495cf:	75 f4                	jne    80495c5 <__do_global_ctors_aux+0x15>; jump if not equal
'-->80495d1:	5b                   	pop    %ebx
